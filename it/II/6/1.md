...
function DOMerase4(newColor) {
  ...
  " Per ciascuna impresa, non produrre affatto è una strategia dominata (da produrre 2000 o 3000 unità). Nel gioco ridotto ottenuto dopo il primo step le strategie rimaste per ciascuna impresa sono quindi produrre 2000, 3000 o 5000 unità."
  ;
  ...
  ;
  document.getElementById("DOMmsg2").innerHTML = 
  " Nel gioco ridotto ottenuto dopo il primo step, per ciascuna impresa produrre 5000 unità è una strategia dominata (da produrne 2000 o 3000). Eliminata questa, le strategie rimaste per ciascuna impresa sono solo produrre 2000 o 3000 unità. <b><i>Nota: questo gioco ridotto è un dilemma del prigioniero!</i></b>"
  ;
  document.getElementById("DOMmsg3").innerHTML = "";
  dom081game4.style.background = newColor;
  dom051game4.style.background = newColor;
  ...
  ;
  document.getElementById("DOMmsg3").innerHTML = 
  " Le imprese producono 3000 unità ciascuna. Il prezzo è quindi 11-(3000+3000)/1000=5 e ciascuna impresa ottiene un profitto pari a (5-2) × 3000=9000. "
  ;
  dom081game4.style.background = newColor;
  dom051game4.style.background = newColor;
  dom041game4.style.background = newColor;
