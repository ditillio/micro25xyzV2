...
Nel <a href="{{ site.baseurl }}/it/I/1">Capitolo 1</a> abbiamo introdotto il concetto di <b>surplus del consumatore</b> e abbiamo preso per buona l'idea di utilizzare la variazione di surplus causata da una variazione di prezzo come misura monetaria della corrispondente variazione di benessere del consumatore. Nella seconda parte di questa sezione daremo un fondamento a quell'idea. In particolare, vedremo che le variazioni di surplus forniscono una ragionevole approssimazione, ponendosi a metà strada tra due misure monetarie <i>esatte</i> delle variazioni di benessere, che discuteremo a breve. Prima di farlo, rivediamo il concetto di surplus del consumatore già introdotto nel Capitolo 1.
