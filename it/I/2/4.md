...
Nell'introduzione abbiamo introdotto il concetto di surplus del consumatore, l'area compresa tra la funzione di domanda di un bene e il prezzo pagato per acquistarlo. E abbiamo preso per buona l'idea di utilizzare la variazione di surplus causata da una variazione di prezzo come misura della corrispondente variazione di benessere del consumatore. Nella seconda parte di questa sezione vedremo che

 .. Per farlo, dobbiamo prima discutere  
