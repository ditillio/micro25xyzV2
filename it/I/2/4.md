...
Supponiamo che le preferenze di un consumatore siano rappresentate dalla funzione di utilità $U(X,Y)=XY$ e il suo reddito sia $M=360$. Come sappiamo, in questo caso la scelta ottima è spendere parti uguali del reddito nei due beni. Se per es. i prezzi sono $P_X=4$ e $P_Y=2$, il consumatore sceglie $X=45$ e $Y=90$. Supponiamo adesso che il prezzo del cibo aumenti a $P_X=9$.
...
area a sinistra della funzione di domanda e compresa fra il nuovo e il vecchio prezzo del bene
