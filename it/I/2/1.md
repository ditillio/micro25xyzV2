...
Le preferenze di Carmen presentano un'altra differenza importante rispetto a quelle di Alice e Bruno. Tra un paniere che presenta quantità positive di entrambi i beni (un paniere <b>interno</b>) e un paniere dove la quantità di uno dei due beni è zero, Alice preferisce sempre il primo. La stessa cosa è vera per Bruno. Ciò è dovuto al fatto che con preferenze Cobb-Douglas ($\sigma=0$) la curva di indifferenza passante per un paniere interno non tocca mai gli assi. Le curve di indifferenza di Carmen, invece, toccano gli assi. Carmen può essere quindi
<span class="marginnote">
